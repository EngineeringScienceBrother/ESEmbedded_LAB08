...
void init_usart1(void)
{
	...
	WRITE_BITS( GPIO_BASE(GPIO_PORTB) + GPIOx_AFRL_OFFSET, 31, 28, 7);  // 0111  0111
	WRITE_BITS( GPIO_BASE(GPIO_PORTB) + GPIOx_AFRL_OFFSET, 27, 24, 7);
	//RCC EN GPIOB
	...
	const double USARTDIV = SYSCLK_MHZ * 1.0e6 / 16 / BAUD;  // Because const and uint32_t double 
